    ...
    def html_snippet(self):
        ...
        <div class="site-admin-box">
            <h4>
                ...
                <img src="https://github.example.net/avatars/u/11?s=100" width="50" height="50" alt="@jdoe" class=" avatar-user" />
            ...
            <ul class="site-admin-detail-list">
                ...
                <small>
                    &ndash;
                    <a href="https://github.example.net/jdoe">View profile</a>
                </small>
                </li>
                <li>
