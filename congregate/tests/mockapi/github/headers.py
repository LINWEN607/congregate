class MockHeaders():
    def get_linked_headers(self):
        return {
            ...
            'Link': '<https://github.example.net/api/v3/organizations?since=12>; rel="next", <https://github.example.net/api/v3/organizations{?since}>; rel="first"',
    ...
    def get_page_2_linked_headers(self):
        return {
            ...
            'Status': '200 OK',
            'X-GitHub-Request-Id': 'd9eb4f1f-9806-4fee-95d8-4ed0630998a0',
            'Link': '<https://github.example.net/api/v3/organizations?since=24>; rel="next", <https://github.example.net/api/v3/organizations{?since}>; rel="first"',
            'Date': 'Fri, 31 Jul 2020 23:29:56 GMT',
            'X-Runtime-Rack': '0.031050',
            'transfer-encoding': 'chunked',
            'Strict-Transport-Security': 'max-age=31536000; includeSubdomains',
    ...
    def get_data(self):
        return [
            ...
            },
            {
                ...
                "id": 10,
                "node_id": "MDEyOk9yZ2FuaXphdGlvbjg=",
                "url": "https://github.example.net/api/v3/orgs/org3",
                "repos_url": "https://github.example.net/api/v3/orgs/org3/repos",
                "events_url": "https://github.example.net/api/v3/orgs/org3/events",
                "hooks_url": "https://github.example.net/api/v3/orgs/org3/hooks",
                "issues_url": "https://github.example.net/api/v3/orgs/org3/issues",
                "members_url": "https://github.example.net/api/v3/orgs/org3/members{/member}",
                "public_members_url": "https://github.example.net/api/v3/orgs/org3/public_members{/member}",
                "avatar_url": "https://github.example.net/avatars/u/8?",
                "description": None
            }
        ]
