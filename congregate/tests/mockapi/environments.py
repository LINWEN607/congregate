class MockEnvironmentsApi():
    '''
        Simulates a /projects/:id/enrvironments request with no additional parameters
    '''

    def get_specific_environment(self):
        return {
            "id": 1,
            "name": "review/fix-foo",
    ...
    def get_environment_404(self):
        return {
            "message": "404 environment Not Found"
        }

    def get_all_environments_generator(self):
        environments = [
            {
                "id": 1,
                "name": "review/fix-foo",
            ...
            {
                "id": 2,
                "name": "review/fix-foo2",
                "slug": "review-fix-foo-dfjre32",
                "external_url": "https://review-fix-foo-dfjre32.example.gitlab.com",
                "state": "available"
            }
        ]
        yield environments