...
class BulkImportsTests(unittest.TestCase):
    ...
    def test_parent_group_exists(self):
        ...
        full_path = 'one/two'
        self.assertTrue(self.bulk_imports.parent_group_exists(full_path, entity_paths))
    ...
    def test_parent_group_doesnt_exist(self):
        ...
        full_path = 'one/two'
        self.assertFalse(self.bulk_imports.parent_group_exists(full_path, entity_paths))
