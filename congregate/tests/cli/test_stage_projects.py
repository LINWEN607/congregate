...
class StageProjectsTests(unittest.TestCase):
    ...
    @mock.patch.object(ProjectStageCLI, 'open_projects_file')
    @mock.patch.object(ProjectStageCLI, 'open_users_file')
    @mock.patch.object(ProjectStageCLI, 'open_groups_file')
