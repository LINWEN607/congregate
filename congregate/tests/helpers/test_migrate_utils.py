...
class MigrateTests(unittest.TestCase):
    ...
    @mock.patch("congregate.helpers.base_module.ConfigurationValidator.dest_parent_id", new_callable=mock.PropertyMock)
    @mock.patch.object(GroupsApi, "get_group")
    @mock.patch.object(ConfigurationValidator, "validate_dest_parent_group_id")
    ...
    @mock.patch.object(ConfigurationValidator, "dest_parent_group_path", new_callable=mock.PropertyMock)
    @mock.patch.object(ConfigurationValidator, "dest_parent_id", new_callable=mock.PropertyMock)
    def test_get_project_namespace(self, parent_id, dest_parent_group_path):
        parent_id.return_value = 4
        dest_parent_group_path.return_value = "test"
    ...
    @mock.patch.object(ConfigurationValidator, "dest_parent_group_path", new_callable=mock.PropertyMock)
    @mock.patch.object(ConfigurationValidator, "dest_parent_id", new_callable=mock.PropertyMock)
    def test_get_dst_path_with_namespace_with_parent_id(self, parent_id, dest_parent_group_path, token, host, user_id, url):
        parent_id.return_value = 1
        dest_parent_group_path.return_value = "test-group"
        token.return_value = "abc"
        host.return_value = "https://gitlab.com"
    ...
    @mock.patch.object(ConfigurationValidator, "dest_parent_group_path", new_callable=mock.PropertyMock)
    @mock.patch.object(ConfigurationValidator, "dest_parent_id", new_callable=mock.PropertyMock)
    def test_get_dst_path_with_namespace_with_parent_id_root(self, parent_id, dest_parent_group_path, token, host, user_id, url):
        parent_id.return_value = 1
        dest_parent_group_path.return_value = "test-group"
        token.return_value = "abc"
        host.return_value = "https://gitlab.com"
    ...
    @mock.patch.object(ConfigurationValidator, "dest_parent_group_path", new_callable=mock.PropertyMock)
    @mock.patch.object(ConfigurationValidator, "dest_parent_id", new_callable=mock.PropertyMock)
    def test_get_dst_path_with_namespace_without_parent_id(self, parent_id, dest_parent_group_path, token, host, user_id, url):
        parent_id.return_value = None
        dest_parent_group_path.return_value = None
        token.return_value = "abc"
        host.return_value = "https://gitlab.com"
        user_id.return_value = 5
        url_value = "https://gitlab.com/api/v4/users/5"
    ...
    @mock.patch.object(ConfigurationValidator, "dest_parent_group_path", new_callable=mock.PropertyMock)
    @mock.patch.object(ConfigurationValidator, "dest_parent_id", new_callable=mock.PropertyMock)
    def test_get_dst_path_with_namespace_without_parent_id_root(self, parent_id, dest_parent_group_path, token, host, user_id, url):
        parent_id.return_value = None
        dest_parent_group_path.return_value = None
        token.return_value = "abc"
        host.return_value = "https://gitlab.com"
    ...
    @mock.patch.object(ConfigurationValidator, "dest_parent_id", new_callable=mock.PropertyMock)
    @mock.patch.object(ConfigurationValidator, "dest_parent_group_path", new_callable=mock.PropertyMock)
    def test_get_full_path_with_parent_namespace_with_parent(self, dest_parent_group_path, parent_id):
        dest_parent_group_path.return_value = "test-parent-group-path"
        parent_id.return_value = 1
    ...
    @mock.patch.object(ConfigurationValidator, "dest_parent_id", new_callable=mock.PropertyMock)
    @mock.patch.object(ConfigurationValidator, "dest_parent_group_path", new_callable=mock.PropertyMock)
    def test_get_full_path_with_parent_namespace(self, dest_parent_group_path, parent_id):
        dest_parent_group_path.return_value = ""
