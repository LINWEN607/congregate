...
class ApiTests(unittest.TestCase):
    ...
    def test_get_params_none(self):
        ...
        self.assertEqual(params, api.get_params(None, 100, 5, False, ""))
    ...
    def test_get_params_none_keyset(self):
        ...
        self.assertEqual(params, api.get_params(None, 100, 5, True, 42))
    ...
    def test_get_params(self):
        ...
        params["page"] = 5
        params["per_page"] = 100
        self.assertEqual(params, api.get_params({"test": "test"}, 100, 5, False, ""))
    ...
    def test_get_last_id(self):
        ...
        self.assertEqual(api.get_last_id(links), "26924")


    def test_get_last_id_none(self):
        self.assertIsNone(api.get_last_id(None))
