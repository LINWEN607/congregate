...
for i, x in enumerate(arr):
    ...
    with open(xpath, 'r') as f:
        ...
        data = {
            "branch": "master", 
            "author_email": "sfirdaus@gitlab.com",
            "author_name": "Syeda Firdaus", 
            "content": str(l)
        }
        if i != (arr_length - 1):
            data["commit_message"] = "Uploading runbook files [skip-ci]"
        else:
            data["commit_message"] = "Uploading runbook files"
