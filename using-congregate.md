...
1. download  `congregate:latest` using `docker pull registry.gitlab.com/gitlab-com/customer-success/tools/congregate:latest`
...
1. navigate to `https://gitlab.com/gitlab-com/customer-success/tools/congregate` and clone the repository to your local machine
